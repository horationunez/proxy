 ...
 * apibuilder 0.14.3 app.apibuilder.io/flow/session/0.4.100/play_2_6_client
 */
package io.flow.session.v0.models {
   ...
   */
  case class SessionExperimentVariant(
    key: String
  )
  ...
  package object json {
    ...
    implicit def jsonReadsSessionLocalSession: play.api.libs.json.Reads[LocalSession] = {
      (
        ...
        (__ \ "experience").read[io.flow.experience.v0.models.ExperienceGeo] and
        (__ \ "experiment").readNullable[io.flow.session.v0.models.SessionExperiment]
    ...
    implicit def jsonReadsSessionOrganizationSession: play.api.libs.json.Reads[OrganizationSession] = {
      (
        ...
        (__ \ "format").readNullable[io.flow.session.v0.models.SessionFormat] and
        (__ \ "experiment").readNullable[io.flow.session.v0.models.SessionExperiment]
    ...
    implicit def jsonReadsSessionSessionExperiment: play.api.libs.json.Reads[SessionExperiment] = {
      (
        ...
        (__ \ "variant").readNullable[io.flow.session.v0.models.SessionExperimentVariant]
      )(SessionExperiment.apply _)
    }
    ...
    implicit def jsonReadsSessionSessionExperimentVariant: play.api.libs.json.Reads[SessionExperimentVariant] = {
      (__ \ "key").read[String].map { x => new SessionExperimentVariant(key = x) }
    }
...
package io.flow.session.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/flow/session/0.4.100/play_2_6_client"
    val Version = "0.4.100"
    val VersionMajor = 0
